...
public:
    SetPoseAction(std::string name) :
        ...
        client("leg_br_joint_action", true),
        actionName(name)
    {
        this->node = node;
        ...
        this->ikClient = node.serviceClient<quadruped_control::SolveIKPose>("/quadruped/leg_br/ik");
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "leg_br_pose_action");
    ROS_INFO("Initialized ros...");

    SetPoseAction actionServer("leg_br_pose_action");
